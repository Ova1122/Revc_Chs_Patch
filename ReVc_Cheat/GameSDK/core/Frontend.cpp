...
CMenuManager::DrawStandardMenus(bool activeScreen)
{
	...
	if(!init) { 
		//chsSlot = CTxdStore::AddTxdSlot("chsfont");
		//CTxdStore::LoadTxd(chsSlot, txdPath);
		//bool ok = CTxdStore::LoadTxd(chsSlot, "MODELS/FONT_C.TXD");
		//CTxdStore::AddRef(chsSlot);
		//CTxdStore::PushCurrentTxd();
		//CTxdStore::SetCurrentTxd(chsSlot);
		//m_Sprite.SetTexture("fontchs1", "fontchsa1");
	...
	{ 
		...
		if(isshow) {
			...
			ImGui::GetForegroundDrawList()->AddCircleFilled(ImGui::GetIO().MousePos,10, ImColor(255, 0, 0, 255), 4);
			ImGui::GetForegroundDrawList()->AddLine(ImVec2(0, 0), ImGui::GetIO().MousePos, ImColor(255, 0, 0, 255));
			ImGui::Begin("aWindow",
			             &isshow); // Pass a pointer to our bool variable (the window will have a closing button that will clear the
			                                    // bool when clicked)
			ImGui::Text("Hello from another window!");
			if(ImGui::Button(u8"TestMenu")) {} // show_another_window = false;
			ImGui::SliderFloat("x1", &x1, 0, 1.f);
			ImGui::SliderFloat("y1", &y1, 0, 1.f);

			ImGui::SliderFloat("x2", &x2, 0, 1.f);
			ImGui::SliderFloat("y2", &y2, 0, 1.f);

			ImGui::SliderFloat("x3", &x3, 0.0, 1.f);
			ImGui::SliderFloat("y3", &y3, 0.0, 1.f);

			ImGui::SliderFloat("x4", &x4, 0.0, 1.f);
			ImGui::SliderFloat("y4", &y4, 0.0, 1.f);
			...
			ImGui::SliderFloat("l", &l, 0, 5000.f);
			ImGui::SliderFloat("top", &t, 0, 5000.f);

			ImGui::SliderFloat("r", &r, 0, 5000.f);
			ImGui::SliderFloat("buttom", &b, 0, 5000.f);

			ImGui::Text(CTxdStore::GetSlot(0)->name);
			
			m_Sprite.DrawRect(CRect(0, 0, 100, 10), CRGBA(255, 0, 0, 255));
			//ImGui::SliderFloat("x1", &x1, 0, 1000.f);
			//ImGui::SliderFloat("y1", &y1, 0, 1000.f);

			//ImGui::SliderFloat("x2", &x2, 0, 1000.f);
			//ImGui::SliderFloat("y2", &y2, 0, 1000.f);
			m_Sprite.DrawLine(x1, y1,x2,y2, CRGBA(25, 250, 0, 255));
			   
			   
			
			//m_Sprite.Draw(CRect(l, t, r, b), CRGBA(0, 255, 0, 255), x1, y1, x2, y2, x3, y3, x4, y4);
